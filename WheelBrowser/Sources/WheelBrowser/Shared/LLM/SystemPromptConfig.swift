...
enum SystemPromptConfig {
    ...
    Match the user's requested depth and level of detail.
    Default to sufficiently detailed answers for non-trivial questions.
    When the user explicitly asks for depth, detail, step-by-step explanation, or thoroughness, provide it.
    Avoid terse summaries unless the user asks for brevity or the question is simple.
    Default to natural, direct prose.
